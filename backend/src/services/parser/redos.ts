 ...
 * analyzer the catalog CI uses. Keeping the check here — shared by the
 * `validate-parsers` CLI (the CI gate) and the in-app contribute endpoint —
 * means "passes locally" and "passes CI" can never diverge again.
 *
