...
- ✅ **request-size** — normalizer aliases `request_size ← request_length`/`bytes_received`; PROXY-007 fires when the access log includes request size (e.g. nginx `$request_length`). **Build phase complete.**
